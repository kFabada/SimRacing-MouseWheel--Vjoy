...
# assign button
vJoy[1].setButton(1,int(keyboard.getKeyDown(Key.D)))
vJoy[1].setButton(2,int(keyboard.getKeyDown(Key.A)))
vJoy[1].setButton(3,int(keyboard.getKeyDown(Key.E)))
vJoy[1].setButton(4,int(keyboard.getKeyDown(Key.R)))
vJoy[1].setButton(5,int(keyboard.getKeyDown(Key.T)))
vJoy[1].setButton(6,int(keyboard.getKeyDown(Key.Space)))
vJoy[1].setButton(7,int(keyboard.getKeyDown(Key.F)))
vJoy[1].setButton(8,int(keyboard.getKeyDown(Key.G)))
vJoy[1].setButton(9,int(keyboard.getKeyDown(Key.H)))
vJoy[1].setButton(9,int(keyboard.getKeyDown(Key.S)))
